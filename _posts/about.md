...
CV : [[PDF] (as of Feb. 2022)](http://kozistr.tech/cv.pdf)
...
- [tensorflow-image-models] :: TensorFlow Image Models (tfimm) is a collection of image models with pretrained weights, obtained by porting architectures from timm to TensorFlow :: [#51](https://github.com/martinsbruveris/tensorflow-image-models/pull/61)
